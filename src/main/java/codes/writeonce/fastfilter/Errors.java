...
class Errors {
    ...
    public static void undefProperty(PropertyAccessorTemplateResult result) throws TemplateEvaluationException {
        throw new TemplateEvaluationException(result.getPosition(), "No such property: " + result.getPropertyName());
    }
