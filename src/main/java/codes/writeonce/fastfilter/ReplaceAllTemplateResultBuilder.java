...
class ReplaceAllTemplateResultBuilder extends SingleValueTemplateResultBuilder {
    ...
    public static ReplaceAllTemplateResultBuilder newInstance(TextPosition position, TemplateResult source,
            Pattern pattern, TemplateResult replacement) {
        return new ReplaceAllTemplateResultBuilder(position, source, pattern, replacement);
    }

    private ReplaceAllTemplateResultBuilder(TextPosition position, TemplateResult source, Pattern pattern,
    ...
    public TemplateResult build() throws TemplateEvaluationException {
        return new ReplaceAllTemplateResult(position, source, pattern, replacement);
    }
}
